...
def test_length(input_value):
    ...
    assert spellcheck.word_count(input_value) < 10, "The has 10 or more words"
    assert spellcheck.char_count(input_value) < 50, "The string has 50 or more characters"
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert spellcheck.first_char(input_value).isupper(), "The String Does not begin with a capital latter"
    assert spellcheck.last_char(input_value)=='.', "The String Does not end with a period"
